...
def catalogo_itens(x):
    ...
    resultado = [f'\n\033[31m{"COMIDAS":=^30}\033[m\n'
                 ...
                 f'[1] \033[32mPoçao Cura Menor Nitszel\033[m - \033[35m35dels\033[m\n'
                 f'[2] \033[32mPoçao Cura Maior NitsZel\033[m - \033[35m100dels\033[m\n'
                 f'[3] \033[32mPoçao Mana Menor Nitszel\033[m - \033[35m30dels\033[m\n'
                 f'[4] \033[32mPoçao Mana Maior Nitszel\033[m - \033[35m90dels\033[m\n'
...
def itens(x=0, y=0, name='', z=0):
    ...
    produtos = [[{"item": ['Comida Promoçao', 'Comida Cara', 'Torta de NitsZel']},
                ...
                [{"item": ['Poçao Cura Menor Nitszel', 'Poçao Cura Maior NitsZel',
                           'Poçao Mana Menor Nitszel', 'Poçao Mana Maior Nitszel']},
                 {"valor": [35, 100, 30, 90]}]]
